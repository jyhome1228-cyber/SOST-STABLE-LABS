...
window.SOST_PROJECTS.push({
  ...
  approach: '메인에서 브랜드 인상과 오전·오후 이용 방식을 먼저 보여주고, 브랜드 소개, 공간 안내, 이용 안내, 예약 안내, 위치와 FAQ로 이어지는 탐색 구조를 구성했습니다. 공간 안내도와 실제 사진은 콘텐츠 안에서 활용하되 포트폴리오에서는 각 페이지의 UI 구조와 예약 동선이 보이도록 화면 캡처 중심으로 보여줍니다.',
  system: [
    '브랜드 소개와 공간 안내 정보 구조',
